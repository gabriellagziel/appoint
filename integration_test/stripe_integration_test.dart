...
void main() {
  ...
  group('Stripe Integration Tests', () {
    ...
    testWidgets('Stripe Subscription Status Management', (final tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      final status = await stripeService.getSubscriptionStatus(testStudioId);
    ...
    testWidgets('Stripe Subscription Details Retrieval', (final tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      final details = await stripeService.getSubscriptionDetails(testStudioId);
    ...
    testWidgets('Stripe Active Subscription Check', (final tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      final isActive = await stripeService.hasActiveSubscription(testStudioId);
    ...
    testWidgets('Stripe Subscription Cancellation', (final tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Stripe Service Error Handling', (final tester) async {
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('Stripe Webhook Simulation', (final tester) async {
      app.main();
      await tester.pumpAndSettle();
