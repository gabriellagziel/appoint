...
/// Legacy function for backward compatibility
Widget createTestAppWithFirebaseHandling(Widget child) =>
    FirebaseTestHelper.createTestAppWithFirebaseHandling(child);
...
Widget createTestApp(Widget child) => MaterialApp(home: child);

// Helper function to create a test widget with Firebase mocks and providers
Widget createTestAppWithProviders(Widget child) => MaterialApp(home: child);
