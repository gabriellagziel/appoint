...
// in appoint/test/features/meeting_share/share_link_validation_test.dart.
...
import 'package:appoint/services/analytics/meeting_share_analytics_service.dart'
    as _i9;
import 'package:appoint/services/security/rate_limit_service.dart' as _i6;
...
class _FakeRateLimitStatus_9 extends _i1.SmartFake
    implements _i6.RateLimitStatus {
  _FakeRateLimitStatus_9(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
///
/// See the documentation for Mockito's code generation for more information.
class MockRateLimitService extends _i1.Mock implements _i6.RateLimitService {
  MockRateLimitService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<bool> allow(
    String? actionKey,
    String? subjectKey, {
    String? userId,
    String? ipAddress,
  ...
  @override
  _i5.Future<_i6.RateLimitStatus> getStatus(
    String? actionKey,
    String? subjectKey, {
    String? userId,
    String? ipAddress,
    String? userAgent,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i5.Future<_i6.RateLimitStatus>.value(_FakeRateLimitStatus_9(
          this,
          Invocation.method(
            #getStatus,
            [
      ...
      ) as _i5.Future<_i6.RateLimitStatus>);

  @override
  _i5.Future<void> cleanupOldRecords() => (super.noSuchMethod(
        Invocation.method(
          #cleanupOldRecords,
          [],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockMeetingShareAnalyticsService extends _i1.Mock
    implements _i9.MeetingShareAnalyticsService {
  MockMeetingShareAnalyticsService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> trackShareLinkCreated({
  ...
  @override
  _i5.Future<void> trackShareLinkClicked({
    required String? shareId,
    required String? meetingId,
    String? groupId,
    required String? source,
  ...
  @override
  _i5.Future<void> trackGroupMemberJoinedFromShare({
    required String? meetingId,
  ...
  @override
  _i5.Future<void> trackRSVPSubmittedFromShare({
    required String? meetingId,
    required String? groupId,
    String? userId,
    String? guestToken,
  ...
  @override
  _i5.Future<void> trackGuestTokenCreated({
    required String? meetingId,
    String? groupId,
  ...
  @override
  _i5.Future<void> trackGuestTokenValidated({
    required String? meetingId,
    required String? token,
  ...
  @override
  _i5.Future<void> trackRateLimitHit({
  ...
  @override
  _i5.Future<void> trackPublicMeetingPageViewed({
    required String? meetingId,
    String? groupId,
    String? shareId,
    String? source,
  ...
  @override
  _i5.Future<Map<String, dynamic>> getMeetingShareAnalytics(
          String? meetingId) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i5.Future<Map<String, dynamic>> getGroupShareAnalytics(String? groupId) =>
      (super.noSuchMethod(
        Invocation.method(
