...
void main() {
  ...
  setUp(() {
    ...
    when(
      () => l10n.authErrorMissingVerificationCode,
    ).thenReturn('missing-verification-code');
    when(
      () => l10n.authErrorMissingVerificationId,
    ).thenReturn('missing-verification-id');
    when(
      () => l10n.authErrorInvalidPhoneNumber,
    ).thenReturn('invalid-phone-number');
    when(
      () => l10n.authErrorMissingPhoneNumber,
    ...
    when(
      () => l10n.authErrorMultiFactorAuthRequired,
    ).thenReturn('multi-factor-auth-required');
    when(
      () => l10n.authErrorMultiFactorInfoNotFound,
    ).thenReturn('multi-factor-info-not-found');
    when(
      () => l10n.authErrorMissingMultiFactorSession,
    ).thenReturn('missing-multi-factor-session');
    when(
      () => l10n.authErrorInvalidMultiFactorSession,
    ).thenReturn('invalid-multi-factor-session');
    when(
      () => l10n.authErrorSecondFactorAlreadyInUse,
    ).thenReturn('second-factor-already-in-use');
    when(
      () => l10n.authErrorMaximumSecondFactorCountExceeded,
    ).thenReturn('maximum-second-factor-count-exceeded');
    when(
      () => l10n.authErrorUnsupportedFirstFactor,
    ).thenReturn('unsupported-first-factor');
    when(
      () => l10n.authErrorEmailChangeNeedsVerification,
    ).thenReturn('email-change-needs-verification');
    when(
      () => l10n.authErrorPhoneNumberAlreadyExists,
  ...
  test(
    ...
    () {
      final codes = <String, String>{
        ...
        'invalid-verification-code': l10n.authErrorInvalidVerificationCode,
        'invalid-verification-id': l10n.authErrorInvalidVerificationId,
        'missing-verification-code': l10n.authErrorMissingVerificationCode,
        ...
        'multi-factor-auth-required': l10n.authErrorMultiFactorAuthRequired,
        'multi-factor-info-not-found': l10n.authErrorMultiFactorInfoNotFound,
        'missing-multi-factor-session': l10n.authErrorMissingMultiFactorSession,
        'invalid-multi-factor-session': l10n.authErrorInvalidMultiFactorSession,
        'second-factor-already-in-use': l10n.authErrorSecondFactorAlreadyInUse,
        'maximum-second-factor-count-exceeded':
            l10n.authErrorMaximumSecondFactorCountExceeded,
        'unsupported-first-factor': l10n.authErrorUnsupportedFirstFactor,
        'email-change-needs-verification':
            l10n.authErrorEmailChangeNeedsVerification,
        'phone-number-already-exists': l10n.authErrorPhoneNumberAlreadyExists,
        ...
        'invalid-dynamic-link-domain': l10n.authErrorInvalidDynamicLinkDomain,
        ...
        'invalid-hash-salt-separator': l10n.authErrorInvalidHashSaltSeparator,
        ...
        'maximum-user-count-exceeded': l10n.authErrorMaximumUserCountExceeded,
        ...
        'missing-oauth-client-secret': l10n.authErrorMissingOauthClientSecret,
        ...
        'unauthorized-continue-uri': l10n.authErrorUnauthorizedContinueUri,
      };
