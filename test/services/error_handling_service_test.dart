...
void main() {
  ...
  setUp(() {
    ...
    when(() => l10n.authErrorAccountExistsWithDifferentCredential)
    ...
    when(() => l10n.authErrorMultiFactorAuthRequired)
        .thenReturn('multi-factor-auth-required');
    when(() => l10n.authErrorMultiFactorInfoNotFound)
        .thenReturn('multi-factor-info-not-found');
    when(() => l10n.authErrorMissingMultiFactorSession)
        .thenReturn('missing-multi-factor-session');
    when(() => l10n.authErrorInvalidMultiFactorSession)
        .thenReturn('invalid-multi-factor-session');
    when(() => l10n.authErrorSecondFactorAlreadyInUse)
        .thenReturn('second-factor-already-in-use');
    when(() => l10n.authErrorMaximumSecondFactorCountExceeded)
    ...
    when(() => l10n.authErrorEmailChangeNeedsVerification)
        .thenReturn('email-change-needs-verification');
    when(() => l10n.authErrorPhoneNumberAlreadyExists)
    ...
    when(() => l10n.authErrorInvalidDynamicLinkDomain)
    ...
    when(() => l10n.authErrorInvalidHashDerivedKeyLength)
    ...
    when(() => l10n.authErrorInvalidSessionCookieDuration)
    ...
    when(() => l10n.authErrorMaximumUserCountExceeded)
    ...
    when(() => l10n.authErrorMissingOauthClientSecret)
    ...
    when(() => l10n.authErrorUnauthorizedContinueUri)
  ...
  test('returns correct localized string for each Firebase Auth error code',
    ...
    final codes = <String, String>{
      ...
      'invalid-hash-parallelization': l10n.authErrorInvalidHashParallelization,
