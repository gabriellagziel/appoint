...
final REDACTED_TOKEN = FutureProvider.family<List<PlaytimeBackground>, String>((ref, category) async {
...
final REDACTED_TOKEN = StateNotifierProvider<PlaytimeSessionsNotifier, AsyncValue<List<PlaytimeSession>>>((ref) {
  return PlaytimeSessionsNotifier();
});

final REDACTED_TOKEN = StateNotifierProvider<PlaytimeBackgroundsNotifier, AsyncValue<List<PlaytimeBackground>>>((ref) {
