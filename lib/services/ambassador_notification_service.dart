...
class AmbassadorNotificationService {
  ...
  static const String ambassadorMonthlyReminderChannel = 'ambassador_monthly_reminder';
  ...
  Future<Map<String, String>> _getLocalizedNotificationTemplates(String languageCode) async {
    try {
