...
class AmbassadorMobileNotifications {
  ...
  Future<void> _createAndroidNotificationChannels() async {
    ...
    await androidPlugin.createNotificationChannel(
      const AndroidNotificationChannel(
        ...
        sound: RawResourceAndroidNotificationSound('promotion_sound'),
      ),
    );
    ...
    await androidPlugin.createNotificationChannel(
      const AndroidNotificationChannel(
        ...
        sound: RawResourceAndroidNotificationSound('celebration_sound'),
      ),
    );
    ...
    await androidPlugin.createNotificationChannel(
      const AndroidNotificationChannel(
        AmbassadorNotificationService.ambassadorMonthlyReminderChannel,
        'Monthly Reminders',
  ...
  Future<void> _handleForegroundMessage(RemoteMessage message) async {
    ...
    if (data.containsKey('type') && _isAmbassadorNotification(data['type'])) {
      await _showLocalNotificationForAmbassadorEvent(message);
    }
  }
  ...
  Future<void> _handleMessageTap(RemoteMessage message) async {
    ...
    switch (action) {
      ...
      case 'open_ambassador_requirements':
        await _navigateToAmbassadorRequirements();
  ...
  void _onNotificationTapped(NotificationResponse response) {
    ...
    switch (response.payload) {
      ...
      case 'ambassador_demotion':
        _navigateToAmbassadorRequirements();
  ...
  Future<void> _showLocalNotificationForAmbassadorEvent(
  ...
  Future<void> sendEnhancedAmbassadorNotification({
  ...
  String _getChannelForType(String type) {
    switch (type) {
      ...
      case 'monthly_reminder':
        return AmbassadorNotificationService.ambassadorMonthlyReminderChannel;
      default:
        return 'default';
    }
  }
  ...
  String _getColorHexForType(String type) =>
      '#${_getColorForType(type).value.toRadixString(16).substring(2)}';
  ...
  Future<void> _navigateToAmbassadorRequirements() async {
