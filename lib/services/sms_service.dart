...
''';
      ...
      await _logSMSAction('additional_parent_invitation_sms_sent', {
        'parentPhone': _maskPhoneNumber(parentPhone),
        'childUserId': childUserId,
      });
    } catch (e) {
      await _logSMSAction('additional_parent_invitation_sms_failed', {
        'parentPhone': _maskPhoneNumber(parentPhone),
        'error': e.toString(),
      });
      rethrow;
...
''';
      ...
      await _logSMSAction('child_deletion_notification_sms_sent', {
        'parentPhone': _maskPhoneNumber(parentPhone),
        'childId': childId,
      });
    } catch (e) {
      await _logSMSAction('child_deletion_notification_sms_failed', {
        'parentPhone': _maskPhoneNumber(parentPhone),
        'error': e.toString(),
      });
      rethrow;
...
''';
      ...
      await _logSMSAction('playtime_limit_warning_sms_failed', {
        'parentPhone': _maskPhoneNumber(parentPhone),
        'error': e.toString(),
      });
      rethrow;
...
''';
      ...
      await _logSMSAction('daily_activity_summary_sms_failed', {
        'parentPhone': _maskPhoneNumber(parentPhone),
        'error': e.toString(),
      });
      rethrow;
