...
class REDACTED_TOKEN implements Exception {
  const REDACTED_TOKEN(this.message);
  final String message;

  @override
  String toString() => 'REDACTED_TOKEN: $message';
}