...
abstract class $AdminBroadcastMessageCopyWith<$Res> {
  factory $AdminBroadcastMessageCopyWith(AdminBroadcastMessage value,
      ...
      _$AdminBroadcastMessageCopyWithImpl<$Res, AdminBroadcastMessage>;
  @useResult
  $Res call(
      {String id,
      String title,
  ...
  $BroadcastTargetingFiltersCopyWith<$Res> get targetingFilters;
}

/// @nodoc
class _$AdminBroadcastMessageCopyWithImpl<$Res,
        $Val extends AdminBroadcastMessage>
    implements $AdminBroadcastMessageCopyWith<$Res> {
  _$AdminBroadcastMessageCopyWithImpl(this._value, this._then);
  ...
  @pragma('vm:prefer-inline')
  $BroadcastTargetingFiltersCopyWith<$Res> get targetingFilters {
    return $BroadcastTargetingFiltersCopyWith<$Res>(_value.targetingFilters,
        (value) {
...
/// @nodoc
abstract class _$$AdminBroadcastMessageImplCopyWith<$Res>
    implements $AdminBroadcastMessageCopyWith<$Res> {
  factory _$$AdminBroadcastMessageImplCopyWith(
          _$AdminBroadcastMessageImpl value,
          $Res Function(_$AdminBroadcastMessageImpl) then) =
      __$$AdminBroadcastMessageImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$AdminBroadcastMessageImplCopyWithImpl<$Res>
    extends _$AdminBroadcastMessageCopyWithImpl<$Res,
        _$AdminBroadcastMessageImpl>
    implements _$$AdminBroadcastMessageImplCopyWith<$Res> {
  __$$AdminBroadcastMessageImplCopyWithImpl(_$AdminBroadcastMessageImpl _value,
...
class _$AdminBroadcastMessageImpl implements _AdminBroadcastMessage {
  ...
  factory _$AdminBroadcastMessageImpl.fromJson(Map<String, dynamic> json) =>
      _$$AdminBroadcastMessageImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AdminBroadcastMessageImplCopyWith<_$AdminBroadcastMessageImpl>
      get copyWith => __$$AdminBroadcastMessageImplCopyWithImpl<
...
BroadcastTargetingFilters _$BroadcastTargetingFiltersFromJson(
    Map<String, dynamic> json) {
...
mixin _$BroadcastTargetingFilters {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $BroadcastTargetingFiltersCopyWith<BroadcastTargetingFilters> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BroadcastTargetingFiltersCopyWith<$Res> {
  factory $BroadcastTargetingFiltersCopyWith(BroadcastTargetingFilters value,
          $Res Function(BroadcastTargetingFilters) then) =
      _$BroadcastTargetingFiltersCopyWithImpl<$Res, BroadcastTargetingFilters>;
  @useResult
  $Res call(
...
/// @nodoc
class _$BroadcastTargetingFiltersCopyWithImpl<$Res,
        $Val extends BroadcastTargetingFilters>
    implements $BroadcastTargetingFiltersCopyWith<$Res> {
  _$BroadcastTargetingFiltersCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$BroadcastTargetingFiltersImplCopyWith<$Res>
    implements $BroadcastTargetingFiltersCopyWith<$Res> {
  factory _$$BroadcastTargetingFiltersImplCopyWith(
          _$BroadcastTargetingFiltersImpl value,
          $Res Function(_$BroadcastTargetingFiltersImpl) then) =
      __$$BroadcastTargetingFiltersImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {List<String>? countries,
...
/// @nodoc
class __$$BroadcastTargetingFiltersImplCopyWithImpl<$Res>
    extends _$BroadcastTargetingFiltersCopyWithImpl<$Res,
        _$BroadcastTargetingFiltersImpl>
    implements _$$BroadcastTargetingFiltersImplCopyWith<$Res> {
  __$$BroadcastTargetingFiltersImplCopyWithImpl(
...
class _$BroadcastTargetingFiltersImpl implements _BroadcastTargetingFilters {
  ...
  factory _$BroadcastTargetingFiltersImpl.fromJson(Map<String, dynamic> json) =>
      _$$BroadcastTargetingFiltersImplFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$BroadcastTargetingFiltersImplCopyWith<_$BroadcastTargetingFiltersImpl>
      get copyWith => __$$BroadcastTargetingFiltersImplCopyWithImpl<
          _$BroadcastTargetingFiltersImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$BroadcastTargetingFiltersImplToJson(
      this,
    );
  }
}
