...
mixin _$AdminBroadcastMessage {
  ...
  List<CustomFormField>? get formFields => throw _privateConstructorUsedError;
  ...
  int? get pollResponseCount => throw _privateConstructorUsedError;
...
class _$REDACTED_TOKEN<$Res,
  ...
  $Res call({
    ...
    Object? pollResponseCount = freezed,
    ...
    return _then(_value.copyWith(
      ...
      clickedCount: freezed == clickedCount
          ...
          : clickedCount // ignore: cast_nullable_to_non_nullable
              as int?,
      pollResponseCount: freezed == pollResponseCount
          ? _value.pollResponseCount
          : pollResponseCount // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$AdminBroadcastMessageImpl implements _AdminBroadcastMessage {
  ...
  @override
  List<CustomFormField>? get formFields {
  ...
  @override
  String toString() {
    return 'AdminBroadcastMessage(id: $id, title: $title, content: $content, type: $type, targetingFilters: $targetingFilters, createdByAdminId: $createdByAdminId, createdByAdminName: $createdByAdminName, createdAt: $createdAt, status: $status, imageUrl: $imageUrl, videoUrl: $videoUrl, externalLink: $externalLink, pollOptions: $pollOptions, formFields: $formFields, scheduledFor: $scheduledFor, sentAt: $sentAt, processedAt: $processedAt, estimatedRecipients: $estimatedRecipients, actualRecipients: $actualRecipients, openedCount: $openedCount, clickedCount: $clickedCount, pollResponseCount: $pollResponseCount, failedCount: $failedCount, pollResponses: $pollResponses, failedRecipients: $failedRecipients, failureReason: $failureReason)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pollResponseCount, pollResponseCount) ||
                other.pollResponseCount == pollResponseCount) &&
