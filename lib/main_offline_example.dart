...
Future<void> initializeOfflineBookingSystem() async {
  ...
  // ref.read(offlineBookingRepositoryProvider.notifier).state = offlineRepository;
}

// Example Riverpod provider for the offline repository
// offlineBookingRepositoryProvider = StateNotifierProvider<OfflineBookingRepository, OfflineBookingRepository>((ref) {
