...
class _GamesTab extends ConsumerWidget {
  @override
  Widget build(BuildContext context, final WidgetRef ref) => Consumer(
...
class _BackgroundsTab extends ConsumerWidget {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (backgrounds.isNotEmpty) ...[
                      _buildSectionHeader(
                        'All Backgrounds (${backgrounds.length})',
                        Colors.blue,
                      ),
                      const SizedBox(height: 12),
                      ...backgrounds.map(
  ...
  void _viewBackgroundDetails(
    BuildContext context,
    final PlaytimeBackground background,
  ) {
