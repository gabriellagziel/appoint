...
class EnhancedDashboardScreen extends ConsumerWidget {
  ...
  Widget _buildDashboard(BuildContext context, WidgetRef ref,
          Map<String, dynamic> stats, AppLocalizations l10n) =>
  ...
  Widget _buildQuickActions(BuildContext context, WidgetRef ref) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            'Quick Actions',
  ...
  Widget _buildRecentActivity(BuildContext context) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            'Recent Activity',
  ...
  Widget _buildUpcomingMeetings(BuildContext context) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
