...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  final List<OnboardingPage> _pages = [
    const OnboardingPage(
      ...
      description:
          'Connect with businesses, coordinate with family, and enjoy safe gaming experiences all in one place.',
    ...
    const OnboardingPage(
      ...
      description:
          'Find and book appointments with local businesses, salons, studios, and service providers with just a few taps.',
    ...
    const OnboardingPage(
      ...
      description:
          'Coordinate schedules, manage family activities, and keep everyone in sync with our family features.',
    ...
    const OnboardingPage(
      ...
      description:
          'Let your children enjoy safe, educational gaming with friends while you maintain full control and oversight.',
      icon: Icons.games,
      color: Colors.green,
    ...
    const OnboardingPage(
      ...
      description:
          'Create your account and start exploring all the features that make APP-OINT the perfect platform for modern families.',
  ...
  Widget _buildPage(OnboardingPage page, AppLocalizations l10n) => Padding(
  ...
  Widget _buildNavigation(AppLocalizations l10n) => Padding(
        padding: const EdgeInsets.all(24),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
