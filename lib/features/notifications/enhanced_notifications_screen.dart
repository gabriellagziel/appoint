...
final notificationsProvider =
  ...
  return [
    ...
    NotificationItem(
      ...
      title: 'System Update',
      message:
          'New features are available. Update your app for the best experience.',
...
class EnhancedNotificationsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: notificationsAsync.when(
        ...
        data: (notifications) =>
            _buildNotificationsList(context, ref, notifications, l10n),
      ),
    );
  }

  Widget _buildNotificationsList(BuildContext context, WidgetRef ref,
      List<NotificationItem> notifications, AppLocalizations l10n) {
  ...
  Widget _buildNotificationTile(
      ...
      Dismissible(
        ...
        child: ListTile(
          ...
          onLongPress: () =>
              _showNotificationOptions(context, ref, notification),
        ),
      );
  ...
  void _handleNotificationTap(
    ...
    switch (notification.type) {
      case NotificationType.booking:
        ...
        Navigator.pushNamed(
            context, '/booking/${notification.actionData?['bookingId']}');
      case NotificationType.message:
        // Navigate to chat
        Navigator.pushNamed(
            context, '/chat/${notification.actionData?['chatId']}');
      case NotificationType.rewards:
        // Navigate to rewards
      ...
      case NotificationType.payment:
        ...
        Navigator.pushNamed(
            context, '/payment/${notification.actionData?['paymentId']}');
      case NotificationType.reminder:
        // Navigate to reminder details
        Navigator.pushNamed(
            context, '/reminder/${notification.actionData?['reminderId']}');
    }
  }
  ...
  void _toggleReadStatus(
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
          content:
              Text('Marked as ${notification.isRead ? 'unread' : 'read'}')),
    );
  }

  void _deleteNotification(
      BuildContext context, WidgetRef ref, String notificationId) {
