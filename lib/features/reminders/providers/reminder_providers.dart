...
final canCreateLocationRemindersProvider = FutureProvider<bool>((ref) async {
  final service = ref.watch(reminderServiceProvider);
  return await service.canCreateLocationReminders();
});

final locationReminderAccessStatusProvider = FutureProvider<ReminderAccessStatus>((ref) async {
  final canCreate = await ref.watch(canCreateLocationRemindersProvider.future);
...
final reminderCreationNotifierProvider = StateNotifierProvider<ReminderCreationNotifier, ReminderCreationState>(
...
class ReminderCreationNotifier extends StateNotifier<ReminderCreationState> {
  ...
  Future<void> createReminder({
    ...
    try {
      ...
      if (e is ReminderLocationAccessDeniedException) {
