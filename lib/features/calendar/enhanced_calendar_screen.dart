...
final eventsProvider = FutureProvider<Map<DateTime, List<CalendarEvent>>>((ref) async {
  ...
  events[tomorrow] = [
    CalendarEvent(
      ...
      endTime: DateTime(tomorrow.year, tomorrow.month, tomorrow.day, 19, 0),
...
class EnhancedCalendarScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          _buildCalendar(context, ref, selectedDay, focusedDay, calendarFormat, eventsAsync),
  ...
  void _addEvent(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => _buildAddEventForm(context),
    );
  }
  ...
  void _handleEventAction(BuildContext context, String action, CalendarEvent event) {
    switch (action) {
      case 'edit':
        _editEvent(context, event);
        break;
