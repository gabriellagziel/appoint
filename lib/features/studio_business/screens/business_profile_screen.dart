...
class _BusinessProfileScreenState extends ConsumerState<BusinessProfileScreen> {
  ...
  Widget _buildBrandingSection() => Card(
        child: Padding(
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                          'No services added yet. Add services to help clients find you.'),
                    ],
                  ),
                ),
            ],
  ...
  Future<void> _uploadImage(ImageType type) async {
    try {
      ...
      if (kIsWeb) {
        ...
        downloadUrl =
            await FirebaseStorageService.instance.uploadFile(file, storagePath);
      }
