// import 'package:appoint/features/studio_business/models/business_subscription.dart'; // Unused
...
class REDACTED_TOKEN
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content:
                Text('Redirecting to Stripe checkout for Professional plan...'),
            backgroundColor: Colors.blue,
          ),
        );
      }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
                'Redirecting to Stripe checkout for Business Plus plan...'),
            backgroundColor: Colors.blue,
          ),
        );
      }
        ...
        child: Column(
          ...
          children: [
            ...
            _buildPlanCard(
              ...
              isCurrentPlan:
                  subscriptionAsync.value?.plan == SubscriptionPlan.starter,
            ),
            ...
            _buildPlanCard(
              ...
              isCurrentPlan: subscriptionAsync.value?.plan ==
  ...
  Widget _buildCurrentSubscriptionCard(BusinessSubscription subscription,
          Map<String, dynamic> mapUsageStats) =>
      Card(
        elevation: 3,
        child: Padding(
                          ...
                          Expanded(
                            child: LinearProgressIndicator(
                              value: mapUsageStats['limit'] > 0
                                  ? (mapUsageStats['current'] /
                                          mapUsageStats['limit'])
                                      .clamp(0.0, 1.0)
                                  : 0.0,
                              backgroundColor: Colors.grey.shade300,
                              valueColor: AlwaysStoppedAnimation<Color>(
                                mapUsageStats['remaining'] > 0
                                    ? Colors.green
                                    : Colors.red,
                              ),
                            ),
  ...
  Widget _buildPromoCodeSection() => Card(
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Divider(),
              _buildComparisonRow(
                  'Meetings per month', '20', 'Unlimited', 'Unlimited'),
              _buildComparisonRow('Business branding', '✗', '✓', '✓'),
              _buildComparisonRow('Map loads/month', '0', '200', '500'),
              _buildComparisonRow('Calendar views', 'Daily only',
              ...
              _buildComparisonRow(
                  'Map overage cost', 'N/A', '€0.01/load', '€0.01/load'),
            ],
          ),
        ),
      );
  ...
  Widget _buildComparisonRow(String feature, String starter,
          String professional, String businessPlus) =>
      Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: businessPlus == '✗'
                      ? Colors.red
                      : businessPlus == '✓' ||
                              businessPlus == 'Advanced' ||
                              businessPlus == 'Priority'
                          ? Colors.green
                          : Colors.grey.shade600,
                  fontWeight: FontWeight.w500,
                ),
