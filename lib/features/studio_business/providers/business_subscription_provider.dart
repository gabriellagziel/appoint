...
final businessSubscriptionServiceProvider = Provider<BusinessSubscriptionService>(
...
final mapUsageNotifierProvider = StateNotifierProvider<MapUsageNotifier, AsyncValue<void>>(
  (ref) => MapUsageNotifier(ref.watch(businessSubscriptionServiceProvider)),
);
...
class BusinessProfileNotifier extends StateNotifier<BusinessProfile?> {
  ...
  Future<bool> _canAccessBranding() async {
    final subscriptionService = _ref.read(businessSubscriptionServiceProvider);
