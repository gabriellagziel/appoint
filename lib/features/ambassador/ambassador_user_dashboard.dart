...
class AmbassadorUserDashboard extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AmbassadorUserDashboard> createState() => _AmbassadorUserDashboardState();
}

class _AmbassadorUserDashboardState extends ConsumerState<AmbassadorUserDashboard>
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  bool _isLoading = true;
  AmbassadorProfile? _profile;
  List<AmbassadorReferral> _recentReferrals = [];
  List<AmbassadorReward> _activeRewards = [];
  ...
  Widget _buildOverviewTab(BuildContext context, AppLocalizations l10n, ThemeData theme) {
  ...
  Widget _buildStatsCards(AppLocalizations l10n, ThemeData theme) {
    return Row(
      children: [
        Expanded(
  ...
  Widget _buildMonthlyGoal(AppLocalizations l10n, ThemeData theme) {
    ...
    final isOnTrack = currentMonthly >= requiredMonthly;
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(
                isOnTrack ? Icons.check_circle_outline : Icons.warning_amber_outlined,
  ...
  Widget _buildReferralsTab(BuildContext context, AppLocalizations l10n, ThemeData theme) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildRewardsTab(BuildContext context, AppLocalizations l10n, ThemeData theme) {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildRewardCard(String title, String description, IconData icon, Color color, ThemeData theme) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          _buildTierCard('Premium', '50+ referrals', Colors.blue, false, theme),
          const SizedBox(height: 8),
          _buildTierCard('Lifetime', '1,000+ referrals', Colors.orange, false, theme),
        ],
      ),
    );
  }

  Widget _buildTierCard(String tier, String requirement, Color color, bool isActive, ThemeData theme) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: isActive ? color.withOpacity(0.1) : theme.colorScheme.surfaceVariant.withOpacity(0.5),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
  ...
  Widget _buildShareTab(BuildContext context, AppLocalizations l10n, ThemeData theme) {
  ...
  Widget _buildShareActions(AppLocalizations l10n, ThemeData theme, String shareLink) {
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: theme.colorScheme.surface,
  ...
  void _shareViaMessage(String link) async {
    await Share.share(
  ...
  void _shareViaEmail(String link) async {
    await Share.share(
  ...
  void _shareGeneral(String link) async {
    await Share.share(
