...
abstract class AppLocalizations {
  ...
  /// Title shown before ad for free users
  ///
  /// In en, this message translates to:
  /// **'Watch an ad to confirm your appointment'**
  String get ad_pre_title;

  /// Description shown before ad for free users
  ///
  /// In en, this message translates to:
  ...
  /// Title shown after ad is finished
  ///
  /// In en, this message translates to:
  /// **'Ad finished! You may now confirm your appointment.'**
  String get ad_post_title;

  /// Button to confirm appointment after ad
  ///
  /// In en, this message translates to:
  /// **'Confirm Appointment'**
  String get confirm_appointment_button;

  /// Title for upgrade prompt
  ///
  /// In en, this message translates to:
  /// **'One-time upgrade'**
  String get upgrade_prompt_title;

  /// Description for upgrade prompt
  ///
  /// In en, this message translates to:
  /// **'Pay €4 to remove all ads forever'**
  String get upgrade_prompt_description;

  /// Button to purchase upgrade
  ///
  /// In en, this message translates to:
  /// **'Purchase Now'**
