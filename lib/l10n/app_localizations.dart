...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'New notification: {payload_title}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'No route defined for {state_uri_path}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'No route defined for {settings_name}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Referrals: {ambassador_referrals}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Appointment: {invite_appointmentId}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Service: {serviceId_Not_selected}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Permission {permission_category} updated to \$newValue'**
  String REDACTED_TOKEN(
      Object invite_appointmentId,
      Object appointment_status_name,
      Object args_slot_format_context,
  ...
  ///
  /// In en, this message translates to:
  /// **'Target: {log_targetType} - {log_targetId}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Permissions - {familyLink_childId}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Staff: {selection_staff_displayName}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Registration failed: {e_toString}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'From: {avail_start_format_context}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Timestamp: {formatDate_log_timestamp}'**
  String REDACTED_TOKEN(
      Object e_toString,
      Object log_action,
      Object invite_appointmentId,
  ...
  ///
  /// In en, this message translates to:
  /// **'Duration: {duration_inMinutes_0} minutes'**
  String REDACTED_TOKEN(
      Object e_toString,
      Object log_action,
      Object invite_appointmentId,
  ...
  ///
  /// In en, this message translates to:
  /// **'Error loading bookings: {snapshot_error}'**
  String REDACTED_TOKEN(
      Object e_toString,
      Object staffId_Not_selected,
      Object log_action,
