...
missing_keys = [
    ...
    'REDACTED_TOKEN', 'authErrorAppNotAuthorized',
    'authErrorCodeExpired', 'authErrorCredentialAlreadyInUse', 'authErrorEmailAlreadyInUse',
    'REDACTED_TOKEN', 'authErrorIdTokenExpired', 'authErrorIdTokenRevoked',
    ...
    'authErrorInvalidDisabledField', 'authErrorInvalidDisplayName', 'REDACTED_TOKEN',
    'authErrorInvalidEmail', 'authErrorInvalidEmailVerified', 'authErrorInvalidHashAlgorithm',
    'authErrorInvalidHashBlockSize', 'REDACTED_TOKEN', 'authErrorInvalidHashKey',
    'authErrorInvalidHashMemoryCost', 'REDACTED_TOKEN', 'authErrorInvalidHashRounds',
    'REDACTED_TOKEN', 'authErrorInvalidIdToken', 'authErrorInvalidLastSignInTime',
    'REDACTED_TOKEN', 'authErrorInvalidPageToken', 'authErrorInvalidPassword',
    'authErrorInvalidPhoneNumber', 'authErrorInvalidProviderData', 'authErrorInvalidProviderId',
    'REDACTED_TOKEN', 'authErrorInvalidUid', 'authErrorInvalidUserImport',
    'REDACTED_TOKEN', 'authErrorInvalidVerificationId', 'REDACTED_TOKEN',
    'REDACTED_TOKEN', 'authErrorMissingAndroidPkgName', 'authErrorMissingContinueUri',
    'authErrorMissingHashAlgorithm', 'authErrorMissingIosBundleId', 'REDACTED_TOKEN',
    'REDACTED_TOKEN', 'authErrorMissingPhoneNumber', 'authErrorMissingUid',
    'REDACTED_TOKEN', 'authErrorMissingVerificationId', 'REDACTED_TOKEN',
    'REDACTED_TOKEN', 'authErrorNetworkRequestFailed', 'authErrorOperationNotAllowed',
    'REDACTED_TOKEN', 'authErrorProjectNotFound', 'authErrorQuotaExceeded',
    'authErrorRequiresRecentLogin', 'authErrorReservedClaims', 'REDACTED_TOKEN',
    'authErrorSessionCookieExpired', 'authErrorSessionCookieRevoked', 'authErrorSessionExpired',
    'authErrorTooManyRequests', 'authErrorUidAlreadyExists', 'REDACTED_TOKEN',
