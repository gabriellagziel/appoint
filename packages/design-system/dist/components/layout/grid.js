...
const Grid = React.forwardRef(({ className, cols = 1, gap = "md", responsive = true, ...props }, ref) => {
    const colClasses = {
        1: "grid-cols-1",
    ...
    return (_jsx("div", { ref: ref, className: cn("grid", colClasses[cols], gapClasses[gap], className), ...props }));
});
