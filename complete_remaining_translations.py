...
def get_remaining_translations():
    ...
    return {
        ...
        'es': {
            ...
            'businessAppointmentsEntryScreenComingSoon': 'Pantalla de entrada de citas comerciales - Próximamente',
            'businessVerificationScreenComingSoon': 'Pantalla de verificación empresarial - Próximamente',
            'businessProfileActivatedSuccessfully': 'Perfil empresarial activado exitosamente',
            'businessProfileEntryScreenComingSoon': 'Pantalla de entrada del perfil empresarial - Próximamente',
            'pleaseActivateYourBusinessProfileToContinue': 'Por favor activa tu perfil empresarial para continuar',
            ...
            'noInvoicesFoundCreateYourFirstInvoice': 'No se encontraron facturas. ¡Crea tu primera factura!',
            ...
            'liveSessionScheduledWaitingForParentApproval': 'Sesión en vivo programada, esperando aprobación del padre',
            ...
            'receiveBookingNotificationsViaSms': 'Recibir notificaciones de reserva por SMS',
            'notifications1': 'Notificaciones',
            'receivePushNotificationsForNewBookings': 'Recibir notificaciones push para nuevas reservas',
            'enableNotifications1': 'Habilitar notificaciones',
            'receiveBookingNotificationsViaEmail': 'Recibir notificaciones de reserva por email',
        ...
        'fr': {
            ...
            'businessAppointmentsEntryScreenComingSoon': 'Écran d\'entrée rendez-vous entreprise - Bientôt disponible',
            'businessVerificationScreenComingSoon': 'Écran de vérification entreprise - Bientôt disponible',
            'businessProfileActivatedSuccessfully': 'Profil entreprise activé avec succès',
            'businessProfileEntryScreenComingSoon': 'Écran d\'entrée profil entreprise - Bientôt disponible',
            'pleaseActivateYourBusinessProfileToContinue': 'Veuillez activer votre profil entreprise pour continuer',
            ...
            'noInvoicesFoundCreateYourFirstInvoice': 'Aucune facture trouvée. Créez votre première facture!',
            ...
            'liveSessionScheduledWaitingForParentApproval': 'Session en direct programmée, en attente d\'approbation parentale',
            ...
            'receiveBookingNotificationsViaSms': 'Recevoir les notifications de réservation par SMS',
            'notifications1': 'Notifications',
            'receivePushNotificationsForNewBookings': 'Recevoir les notifications push pour les nouvelles réservations',
            'enableNotifications1': 'Activer les notifications',
            'receiveBookingNotificationsViaEmail': 'Recevoir les notifications de réservation par email',
        ...
        'de': {
            ...
            'businessAppointmentsEntryScreenComingSoon': 'Business-Termineingangsbildschirm - Bald verfügbar',
            'businessVerificationScreenComingSoon': 'Business-Verifizierungsbildschirm - Bald verfügbar',
            'businessProfileActivatedSuccessfully': 'Business-Profil erfolgreich aktiviert',
            'businessProfileEntryScreenComingSoon': 'Business-Profileingangsbildschirm - Bald verfügbar',
            'pleaseActivateYourBusinessProfileToContinue': 'Bitte aktivieren Sie Ihr Business-Profil, um fortzufahren',
            ...
            'noInvoicesFoundCreateYourFirstInvoice': 'Keine Rechnungen gefunden. Erstellen Sie Ihre erste Rechnung!',
            ...
            'liveSessionScheduledWaitingForParentApproval': 'Live-Session geplant, warten auf Elterngenehmigung',
            ...
            'receiveBookingNotificationsViaSms': 'Buchungsbenachrichtigungen per SMS erhalten',
            'notifications1': 'Benachrichtigungen',
            'receivePushNotificationsForNewBookings': 'Push-Benachrichtigungen für neue Buchungen erhalten',
            'enableNotifications1': 'Benachrichtigungen aktivieren',
            'receiveBookingNotificationsViaEmail': 'Buchungsbenachrichtigungen per E-Mail erhalten',
        ...
        'it': {
            ...
            'businessAppointmentsEntryScreenComingSoon': 'Schermata inserimento appuntamenti business - Prossimamente',
            'businessVerificationScreenComingSoon': 'Schermata verifica business - Prossimamente',
            'businessProfileActivatedSuccessfully': 'Profilo business attivato con successo',
            'businessProfileEntryScreenComingSoon': 'Schermata inserimento profilo business - Prossimamente',
            'pleaseActivateYourBusinessProfileToContinue': 'Per favore attiva il tuo profilo business per continuare',
            ...
            'noInvoicesFoundCreateYourFirstInvoice': 'Nessuna fattura trovata. Crea la tua prima fattura!',
            ...
            'liveSessionScheduledWaitingForParentApproval': 'Sessione live programmata, in attesa dell\'approvazione del genitore',
            ...
            'receiveBookingNotificationsViaSms': 'Ricevi notifiche prenotazione via SMS',
            'notifications1': 'Notifiche',
            'receivePushNotificationsForNewBookings': 'Ricevi notifiche push per nuove prenotazioni',
            'enableNotifications1': 'Abilita notifiche',
            'receiveBookingNotificationsViaEmail': 'Ricevi notifiche prenotazione via email',
