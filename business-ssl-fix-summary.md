...
3. **Check Logs**: `doctl apps logs 620a2ee8-e942-451c-9cfd-8ece55511eb8 --type deploy`

### **If Deployment Fails**
1. **Check Token**: Ensure DIGITALOCEAN_ACCESS_TOKEN is valid
2. **Verify Permissions**: Token needs app management permissions
3. **Check App ID**: Verify 620a2ee8-e942-451c-9cfd-8ece55511eb8 is correct
...
1. **DigitalOcean Dashboard**: https://cloud.digitalocean.com/apps/620a2ee8-e942-451c-9cfd-8ece55511eb8
