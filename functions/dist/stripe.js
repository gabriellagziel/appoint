...
function getStripe() {
    ...
    if (!stripeSingleton) {
        ...
        stripeSingleton = new stripe_1.default(process.env.STRIPE_SECRET_KEY || 'sk_test_your_secret_key_here', {});
    }
    return stripeSingleton;
}
...
exports.createPaymentIntent = (0, https_1.onCall)(async (data, context) => {
    try {
        // Basic validation
