...
exports.sendPerformanceWarningNotification = sendPerformanceWarningNotification;
 ...
 */
exports.sendAmbassadorNotification = functions.https.onCall(async (notificationData, context) => {
    if (!context.auth) {
    ...
    try {
        ...
        for (const doc of ambassadors.docs) {
            ...
            if (profile.monthlyReferrals < 10) {
                await (0, exports.sendAmbassadorNotification)({
...
async function sendPerformanceWarningNotification(userId, languageCode, currentReferrals, minimumRequired) {
    await (0, exports.sendAmbassadorNotification)({
        userId,
