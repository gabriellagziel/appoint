...
exports.monthlyBillingJob = functions.pubsub
...
exports.monthlyMapOverageBilling = functions.pubsub
...
exports.generateMapOverageInvoice = functions.https.onCall(async (data, context) => {
 ...
 */
exports.importBankPayments = functions.https.onRequest(async (req, res) => {
    if (req.method !== 'POST') {
...
exports.resetMapUsageForNewPeriod = functions.https.onCall(async (data, context) => {
