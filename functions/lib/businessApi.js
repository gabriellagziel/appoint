...
export const registerBusiness = onRequest(async (req, res) => {
    ...
    try {
        const { companyName, website, address, vat, registration, country, currency, billingEmail, rep, taxId, firstName, lastName, email, phone, usage, intent, industry, size, tos, marketing } = req.body || {};
