...
FIREBASE_TOKEN="1//03_firebase_ci_token_from_login_ci_command"
...
echo "• DIGITALOCEAN_ACCESS_TOKEN = dop_v1_76ab2ee2f0b99b5d1bdb5291352f4413053f2c31edda0fbbefcd787a88c91dbb"
echo "• APP_ID = 620a2ee8-e942-451c-9cfd-8ece55511eb8"  
...
endpoint_results["POST_businessApi_appointments_create"]="pass"
...
endpoint_results["POST_businessApi_appointments_cancel"]="pass"
...
cat << EOF
{
  ...
  "step_4_smoke_tests": {
    ...
    "endpoint_results": {
      ...
      "POST_businessApi_appointments_create": "${endpoint_results[POST_businessApi_appointments_create]}",
      "GET_businessApi_appointments": "${endpoint_results[GET_businessApi_appointments]}",
      "POST_businessApi_appointments_cancel": "${endpoint_results[POST_businessApi_appointments_cancel]}",
