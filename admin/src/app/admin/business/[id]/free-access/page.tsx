...
export default function BusinessFreeAccessPage() {
  ...
  const loadActiveGrant = async () => {
    try {
      setLoading(true);
      const grant = await freeAccessService.getActiveGrant('business', businessId);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Manage free access for business: <code className="bg-muted px-1 rounded">{businessId}</code>
            </p>
          </div>
        </div>
      </div>
          ...
          {loading ? (
                ...
                >
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to revoke free access for this business? 
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                This business does not have any active free access grants.
              </p>
      ...
      {/* Grant History */}
      <GrantHistory targetType="business" targetId={businessId} />
    </div>
  );
}
