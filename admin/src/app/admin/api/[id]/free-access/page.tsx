...
export default function EnterpriseFreeAccessPage() {
  ...
  const loadActiveGrant = async () => {
    try {
      setLoading(true);
      const grant = await freeAccessService.getActiveGrant('enterprise', clientId);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Manage free access for enterprise client: <code className="bg-muted px-1 rounded">{clientId}</code>
            </p>
          </div>
        </div>
      </div>
          ...
          {loading ? (
                ...
                >
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to revoke free access for this enterprise client? 
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                This enterprise client does not have any active free access grants.
              </p>
      ...
      {/* Grant History */}
      <GrantHistory targetType="enterprise" targetId={clientId} />
    </div>
  );
}
