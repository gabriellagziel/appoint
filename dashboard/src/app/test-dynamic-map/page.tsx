...
export default function TestDynamicMapPage() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-6">
        <h1 className="text-3xl font-bold mb-2">Dynamic Map Preview Test</h1>
        <p className="text-gray-600">
          Test the dynamic OpenStreetMap iframe implementation
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Dynamic Map Preview</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="h-96">
              <iframe
                src={`/widgets/map-preview.html?lat=${latitude}&lng=${longitude}&zoom=15&address=${encodeURIComponent(address)}`}
                width="100%"
                height="100%"
