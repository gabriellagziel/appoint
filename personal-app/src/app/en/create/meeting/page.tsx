        ...
        <main className="mx-auto max-w-screen-sm px-4 pb-24 pt-8 space-y-4">
            ...
            {step === 2 && (
                <section className="space-y-3">
                    ...
                    <input className="w-full rounded-xl border p-3" placeholder="Type a name (mock)" onKeyDown={(e) => {
            ...
            {step === 3 && (
                <section className="space-y-3">
                    ...
                    <div className="grid gap-3">
                        <input className="rounded-xl border p-3" placeholder="Date (e.g., 2025-09-01)" value={details.date} onChange={e => setDetails({ ...details, date: e.target.value })} />
                        <input className="rounded-xl border p-3" placeholder="Time (e.g., 17:00)" value={details.time} onChange={e => setDetails({ ...details, time: e.target.value })} />
                        <input className="rounded-xl border p-3" placeholder="Location or Platform (Zoom/Meet/Phone)" value={details.location} onChange={e => setDetails({ ...details, location: e.target.value })} />
                    </div>
                    <div className="flex gap-3">
